                ...
                <div class="col-lg-12 col-md-12 col-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    <span class="fw-semibold d-block mb-1">Total NGO's</span>
                                    <h5 class="card-title mb-2">2</h5>
                                    Active<small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i>
                                        2</small>
                                    &nbsp; &nbsp;
                                    Inactive<small class="text-danger fw-semibold"><i class="bx bx-down-arrow-alt"></i>
                    ...
                    <div class="tab-content p-0">
                        <div class="tab-pane fade show active" id="navs-tabs-line-card-income" role="tabpanel">
                            <div class="d-flex p-4 pt-3">
                                ...
                                <div>
                                    <small class="text-muted d-block">Product Maintaince</small>
                                    <div class="d-flex align-items-center">
                                        <h6 class="mb-0 me-1">₹00.00</h6>
